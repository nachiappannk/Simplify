...
{
    public class ClosedAssetSummary : AssetSummary<List<SquarableStatement>>
    {
        public ClosedAssetSummary(Dictionary<string, List<SquarableStatement>> dictionary) : base(dictionary)
        {
        }
